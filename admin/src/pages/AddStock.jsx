        ...
        <section className="add-stock section-gaps">
            <div className="container">
                <div className="d-flex justify-content-between align-items-center mb-4">
                    ...
                    <button onClick={handleRefresh} className="btn btn-blue" disabled={refreshing}>
                        {refreshing ? (
                            <>
                                <LoadingSpinner size="sm" color="light" className="me-2" /> Refreshing...
                            </>
                        ) : (
                            <>
                                ...
                                currentProducts.map((product) => (
                                    <tr key={product._id}>
                                        ...
                                        <td>
                                            ...
                                            {getSubCategoryName(product) && ` / ${getSubCategoryName(product)}`}
                                        </td>
                                        <td>
