...
const InsertCategory = () => {
    ...
    const handleInsertCategory = async (e) => {
        ...
        try {
            ...
            await axios.post(`${backendUrl}/api/product/categories`, {
                name: trimmedName,
            });
    ...
    const handleDeleteCategory = async (id, name) => {
        ...
        try {
            ...
            toast.error(
                error.response?.data?.message || 'Error occurred while deleting the category'
            );
        }
    };
                    ...
                    <div className="card-body">
                        <form onSubmit={handleInsertCategory}>
                            <div className="mb-3">
                                ...
                                <input type="text" id="categoryName" className="form-control" value={categoryName} onChange={(e) => setCategoryName(e.target.value)} required disabled={isSubmitting}/>
                            </div>
                            <button type="submit" className="btn btn-blue" disabled={isSubmitting || !categoryName.trim()} >
                            {isSubmitting ? (
                                <>
                                <span
