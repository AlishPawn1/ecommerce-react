...
const List = () => {
    ...
    const removeProduct = async (id) => {
        ...
        try {
            ...
            console.error(error);
            toast.error(error.response?.data?.message || 'Error occurred while deleting the product');
        }
    };
                                    ...
                                    {currentProducts.length > 0 ? (
                                        currentProducts.map((product) => (
                                            <tr key={product._id}>
                                                ...
                                                <td>{product.size?.length > 0 ? product.size.join(', ') : '-'}</td>
                                                <td>{product.stock}</td>
                                                <td>
                                        ...
                                        <tr>
                                            <td colSpan="9" className="text-center py-4">
                                                {list.length === 0 ? 'No products available.' : 'No products match your search.'}
                                            </td>
                                        </tr>
                                    )}
                                </tbody>
