...
var sendEmail = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee(toEmail, subject, message) {
    var mailOptions, _t;
    return _regenerator().w(function (_context) {
      while (1) switch (_context.p = _context.n) {
        ...
        case 3:
          _context.p = 3;
          _t = _context.v;
          console.error("Error sending email:", _t);
          if (_t.response) {
            console.error(_t.response.body);
          }
        case 4:
          return _context.a(2);
      }
