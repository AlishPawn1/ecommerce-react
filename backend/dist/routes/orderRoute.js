...
import { placeOrder, placeOrderStripe, placeOrderKhalti, verifyStripe, verifyKhalti, allOrders, userOrder, updateStatus, updatePaymentStatus, getOrdersByDays } from "../controllers/orderController.js";
...
orderRouter.get("/status-counts", /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee(req, res) {
    var statuses, counts, _i, _statuses, status, _t;
    return _regenerator().w(function (_context) {
      while (1) switch (_context.p = _context.n) {
        case 0:
          _context.p = 0;
          statuses = ["Pending", "Packing", "Shipping", "Out for Delivery", "Completed"];
          counts = {};
