...
export const products = [
  ...
  },
  {
    ...
    price: 250,
    images: [productImage7, productImage8, productImage9],
  ...
  },
  {
    ...
    price: 25,
    images: [productImage10, productImage11],
    category: 'Clothing',
  ...
  },
  {
    ...
    price: 60,
    images: [productImage12, productImage13, productImage14],
    category: 'Clothing',
    subcategory: 'Jeans',
    size: ['S', 'M', 'L', 'XL'],
    date: '2025-01-25',
  ...
  },
  {
    ...
    price: 110,
    images: [productImage15, productImage1, productImage2],
    category: 'Footwear',
    subcategory: 'Formal',
    size: ['S', 'M', 'L', 'XL'],
    date: '2025-02-01',
