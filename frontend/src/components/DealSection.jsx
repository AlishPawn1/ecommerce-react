...
const DealSection = () => {
  return (
    <section
      className="deal-section section-gap bg-cover bg-[0_-40px]"
      style={{ backgroundImage: `url(${assets.sectionbg4})` }}
    >
          ...
          <div className="sm:w-7/12">
            <div className="flex justify-center wow animate__ animate__zoomIn animated">
              <div className="text-center">
                ...
                <p className="pb-5">
                  Immerse yourself in the heritage of Newari culture through our
