        ...
        <div className="flex flex-col sm:grid grid-cols-[3fr_1fr_1fr] gap-14 my-20 mt-40 text-sm">
          <div>
            ...
            <p className="w-full md:w-2/3 text-gray-600">
              Thank you for visiting our store. We’re committed to offering
              quality products, secure shopping, and exceptional customer
              service. Stay connected for the latest updates and exclusive
              offers.
            </p>
          </div>
          <div>
            ...
            <ul className="flex flex-col gap-1 text-gray-600 capitalize">
              ...
              <li>
                <Link to="/info-policy">Privacy Policy</Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="flex flex-col gap-1 text-gray-600 capitalize">
              ...
              <li>
                <Link to="mailto: Newaritraditionaldress@gmail.com">
                  Newaritraditionaldress@gmail.com
                </Link>
              </li>
            </ul>
          </div>
