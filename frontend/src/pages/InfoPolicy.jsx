...
const InfoPolicy = () => {
  return (
    <div className="max-w-4xl mx-auto px-4 py-12 text-gray-800">
      ...
      <p className="mb-4">
        At Traditional Newari Shop, we value your privacy and are committed to
      ...
      <p className="mb-4">
        We implement appropriate security measures to protect your data. Payment
      ...
      <p className="mb-4">
        ...
        shared with trusted partners for services like payment processing and
        shipping.
      </p>
      ...
      <p className="mb-4">
        ...
        information. Contact us at support@traditionshop.com to make a request.
      </p>
      ...
      <p className="mb-4">
        ...
        for changes. Continued use of our site means you accept the updated
        policy.
      </p>

      <p className="text-sm text-gray-600 mt-10">Last updated: June 28, 2025</p>
    </div>
  );
};
