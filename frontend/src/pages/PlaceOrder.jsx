                    ...
                    <div className="mt-12">
                        ...
                        <div className="grid gap-3 grid-cols-1 lg:grid-cols-4 sm:grid-cols-2 ">
                            <div onClick={() => setMethod('esewa')} className="flex items-center gap-3 border p-2 px-3 cursor-pointer">
                                <p className={`min-w-3.5 h-3.5 border rounded-full ${method === 'esewa' ? 'bg-green-400 border-green-400' : ''}`}></p>
                                <img src={assets.esewa} className='h-5' alt="" />
                            </div>
                            <div onClick={() => setMethod('khalti')} className="flex items-center gap-3 border p-2 px-3 cursor-pointer">
                                <p className={`min-w-3.5 h-3.5 border rounded-full ${method === 'khalti' ? 'bg-green-400 border-green-400' : ''}`}></p>
                                <img src={assets.khalti} className='h-5' alt="" />
                            </div>
                            <div onClick={() => setMethod('stripe')} className="flex items-center gap-3 border p-2 px-3 cursor-pointer">
                                <p className={`min-w-3.5 h-3.5 border rounded-full ${method === 'stripe' ? 'bg-green-400 border-green-400' : ''}`}></p>
                                <img src={assets.stripeLogo} className='h-5' alt="" />
                            </div>
                        ...
                        <div className="w-full text-end mt-8">
                            <button onClick={()=> navigate('/order')} className="btn-black">Place Order</button>
                        </div>
                    </div>
                </div>
            </div>
